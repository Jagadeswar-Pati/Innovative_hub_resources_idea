...
const AboutPage = () => {
  return (
    <Layout>
      <SEO
        title="About Us"
        description="Learn about Innovative Hub – your one-stop destination for electronics, robotics, and DIY innovation. Our mission is to empower makers, students, and professionals."
        path="/about"
      />
