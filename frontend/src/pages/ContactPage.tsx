...
const ContactPage = () => {
  ...
  return (
    <Layout>
      <SEO
        title="Contact Us"
        description="Have questions or need assistance? Contact Innovative Hub for support, 3D printing inquiries, and expert help. We typically respond within 24 hours."
        path="/contact"
      />
