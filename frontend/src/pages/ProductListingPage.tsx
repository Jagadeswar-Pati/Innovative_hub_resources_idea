...
const ProductListingPage = ({ useMainLayout = false }: ProductListingPageProps) => {
  ...
  const content = (
    <>
      <SEO
        title={currentCategory === 'All Products' ? 'All Products' : currentCategory}
        description={`Browse ${currentCategory.toLowerCase()} at Innovative Hub. Quality electronic components and robotics parts.`}
        path="/eshop/products"
      />
