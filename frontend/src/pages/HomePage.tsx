...
const HomePage = () => {
  return (
    <>
        <SEO
        title="Innovative Hub | Robotics, IoT & Embedded Systems"
        description="Your all-in-one innovation platform for robotics, IoT, and embedded systems. We provide the tools, knowledge, and community to transform your ideas into real-world solutions."
        path="/"
      />
